                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100 w-[60%]">
                        <div class="px-10 flex items-center w-full">
                            <div class="" >
                                ...
                                <div class="rounded-full w-32 h-32 bg-blue-600 bg-no-repeat bg-cover" style="background-image: url('{{ asset('profile_pictures/'.$stagiaire->pp_path) }}')">
                            ...
                            <div class="p-3 bg-gray-300 dark:bg-gray-700 rounded-lg  w-full border-gray-600 ml-3">
                                <table>
                                    <tr class="">
                                        ...
                                        <td class="pl-3">{{ $stagiaire->nom }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-2">Prenom: </td>
                                        <td class="pl-3">{{ $stagiaire->prenom }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-2">Fillier: </td>
                                        <td class="pl-3">{{ $stagiaire->groupes->filliere->nom }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="py-2">groupe: </td>
                                        <td class="pl-3">{{ $stagiaire->groupes->libelle }} </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
